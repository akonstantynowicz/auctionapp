...
<div class="boughtAuctions">
  <h1 v-if="auctions.length">KUPIONE AUKCJE</h1>
  <h1 v-else>BRAK KUPIONYCH AUKCJI</h1>
  <p class="error" v-if="error">{{ error }}</p>
   <div class="boughtAuctionsFor"
    ...
    <div class="boughtAuction">
        ...
        <p class="price" v-if="auction.isAuctionable">PRZEDMIOT WYLICYTOWANY ZA {{ auction.price }} zł</p>
        <p class="price" v-else>PRZEDMIOT KUPIONY ZA {{ auction.price }} zł</p>
    </div>
   </div>
</div>
</template>
